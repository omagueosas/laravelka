...
<header>
    ...
    </br><label for="sname"><b>Surname</b></label>
    <input type="text" placeholder="Введите фамилию (не обязательно)" name="sname">

    </br><label for="login"><b>Login</b></label>
    ...
    </br><label for="pswrep"><b>password_repeat </b></label>
    <input type="password" placeholder="Введите пароль" name="pswrep" required>

    </br><label><input type="checkbox" checked="checked" name="remember"> Rules</label>
